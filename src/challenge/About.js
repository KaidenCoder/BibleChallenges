    ...
    return (
        <React.Fragment>
            ...
            <div style={{ textAlign: "justify", padding: "40px", background: 'rgba(0,0,255,0.4)', margin: '0', fontFamily: "monospace" }}>
                ...
                <p>Commit to studying your Bible topic for at least 30 minutes a day for 30 days, 60 days etc. Easy-peasy. To keep yourself accountable, and use your community for support, you will journal your daily progress on the Whatsapp group.</p>
